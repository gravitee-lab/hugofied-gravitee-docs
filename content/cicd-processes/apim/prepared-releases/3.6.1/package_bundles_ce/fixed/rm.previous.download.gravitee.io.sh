...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/distributions/graviteeio-full-3.6.1.zip ${S3_BASE_URL}/graviteeio-apim/distributions/graviteeio-full-3.6.1.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/reporters/gravitee-reporter-elasticsearch/gravitee-reporter-elasticsearch-3.6.0.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/reporters/gravitee-reporter-file/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/reporters/gravitee-reporter-file/gravitee-reporter-file-2.1.1.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-gateway-bridge-http-server/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-gateway-bridge-http-server/gravitee-repository-gateway-bridge-http-server-3.6.1.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-mongodb/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-mongodb/gravitee-repository-mongodb-3.6.1.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-jdbc/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-jdbc/gravitee-repository-jdbc-3.6.1.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-elasticsearch/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-elasticsearch/gravitee-repository-elasticsearch-3.6.0.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-gateway-bridge-http-client/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/repositories/gravitee-repository-gateway-bridge-http-client/gravitee-repository-gateway-bridge-http-client-3.6.1.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/resources/gravitee-resource-oauth2-provider-am/gravitee-resource-oauth2-provider-am-1.13.0.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/policies/gravitee-policy-retry/gravitee-policy-retry-1.1.0.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/policies/gravitee-policy-jwt/gravitee-policy-jwt-1.17.0.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/policies/gravitee-policy-http-signature/gravitee-policy-http-signature-1.0.1.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/policies/gravitee-policy-ipfiltering/gravitee-policy-ipfiltering-1.7.0.zip
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/plugins/policies/gravitee-policy-json-xml/gravitee-policy-json-xml-1.0.0.zip 
...
rm ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-gateway/graviteeio-gateway-3.6.1.zip 
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-management-rest-api/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-management-rest-api/gravitee-management-rest-api-3.6.1.zip
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-portal-webui/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-portal-webui/gravitee-portal-webui-3.6.1.zip 
# mkdir -p ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-management-webui/
rm ${BASE_WWW_FOLDER}/graviteeio-apim/components/gravitee-management-webui/gravitee-management-webui-3.6.1.zip 
