...
* can be run in parallel :
  * 2. package n publish zip bundles
  * 3. nexus-staging
* En parallèle :
  * 4. docker images CE and EE
  * 5. rpm
  * 6. changelog
  * 7. continuous delivery of https://docs.gravitee.io (truc à valider pour les branchesde départ et arrivée)
